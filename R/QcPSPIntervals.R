...
getMetaData <- function(dFrame) {
  ...
  if (objectName == "QcNbHarvestedTreesByIntervals") {
    ...
    description <- c("PSP identifier after plot filtering and correction.",
                     "Index of initial measurement of the interval. Refers to variable k in table QcMeasurementIndex",
                     ...
                     "Index of final measurement of the interval. Refers to variable k in table QcMeasurementIndex",
